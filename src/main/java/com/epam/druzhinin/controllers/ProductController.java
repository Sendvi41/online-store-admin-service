...
public class ProductController {
    ...
    public MessageDto uploadProductImage(@PathVariable Long productId, @RequestParam("image") MultipartFile image) {
        return imageService.uploadProductImage(productId, image);
    }
